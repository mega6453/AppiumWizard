...
LicenseFile=ExcludeInInstaller\Freeware License.txt
InfoBeforeFile=ExcludeInInstaller\Information.txt
SetupIconFile=ExcludeInInstaller\appiumlogo.ico
...
Source: "*"; DestDir: "{app}"; Flags: ignoreversion; Excludes:"Installer Script.iss"
